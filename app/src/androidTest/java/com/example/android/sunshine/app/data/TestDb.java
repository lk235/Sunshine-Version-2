...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        assertTrue("Error: NO Records returned from WeatherEntry query", cursor.moveToFirst());

        // Validate data in resulting Cursor with the original ContentValues
        TestUtilities.validateCurrentRecord("testInsertReadDb weatherEntry failed to validate",cursor, contentValues);
        assertFalse("Error: More than one Record returned from WeatherEntry query", cursor.moveToNext());
